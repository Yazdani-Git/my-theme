...
class moboland_product_category extends \Elementor\Widget_Base
{
    ...
    {
        return 'اسلایدر دسته بندی محصولات موبولند';
    }
        ...
        $this->add_control(
            ...
            [
                ...
                'fields' => [
                    ...
                    [
                        'name' => 'text_main_category',
                        'label' => 'عنوان دسته بندی را وارد کنید',
                        'type' => \Elementor\Controls_Manager::TEXT,
                    ],
                    [
                        'name' => 'url_main_category',
    ...
    protected function render()
    {
        ...
        $categories = $settings['main_category_list'];
        ?>
        ...
        <section class="product-cat-home">
            <div class="container">
                <div class="product-cat">
                    <div class="owl-carousel owl-theme product-cat-slider">
                        <?php foreach ($categories as $category) { ?>
                            <div class="item product-cat-item">
                                <figure>
                                    <a href="<?php echo $category['url_main_category']['url'] ?>"><img
                                                src="<?php echo $category['image_main_category']['url'] ?>"
                                                alt=""></a>
                                </figure>
                                <a href="<?php echo $category['url_main_category']['url'] ?>" class="btn-text">
                                    <?php echo $category['text_main_category'] ?>
                                </a>
                                <div class="item-action">
                                    <a href="<?php echo $category['url_main_category']['url'] ?>">
                                        <button>
        ...
        <script>
            ...
            $(function () {
                $('.product-cat-slider').owlCarousel({
                    ...
                    margin: 10,
                    nav: <?php if ($settings['show_nav_category']) {
                        echo "true";
                    } else {
                        echo "false";
                    } ?>,
                    ...
                    responsive: {
                        ...
                        992: {
                            items: <?php echo $settings['item_slide_cat_tablet']; ?>
                        },
                        1000: {
                            items: 7
                        },
                        1400: {
                            items: <?php echo $settings['item_slide_cat_desktop']; ?>
                        }
                    }
                })
            })
