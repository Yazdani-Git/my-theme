...
<div class="row sms-ir-main-div sms-ir-setting-main-div">
    <div class="col-md-12" id="smsIrTabMenu">
        <div class="nav-tab-wrapper">
            ...
            <a href="#Wordpress" onclick="smsIrChangeTab('Wordpress')" class="nav-tab">ورود و ثبت نام</a>
            <a href="#Woocommerce" onclick="smsIrChangeTab('Woocommerce')" class="nav-tab ">اعلانات ووکامرس</a>
            <a href="#Gravity" onclick="smsIrChangeTab('Gravity')" class="nav-tab ">گرویتی فرم</a>
            <a href="#Contact" onclick="smsIrChangeTab('Contact')" class="nav-tab ">فرم تماس 7</a>
        </div>
    </div>
    <div class="col-md-12" id="smsIrTabContent">
        <form action="" method="post">
            ...
            <div class="sms-ir-tab" style="display: none" id="smsIrWordpressTab">
                <table class="form-table sms-ir-form-table">
                    <tbody>
                    <!-- شناسه قالب ارسال کد تایید -->
                    <tr>
                        <td class="form-table-input">
                            <p class="sms-ir-label">شناسه قالب ارسال کد تایید:
                                <i class="dashicons dashicons-info"
                                   title="شناسه قالب ارسال سریع پیامک که برای ارسال کد تایید به کاربران استفاده می‌شود. این شناسه باید در پنل پیامکی sms.ir ثبت شده باشد."></i>
                            </p>
                        </td>
                        <td class="form-table-input">
                            <input type="number" name="sms_ir_verification_template_id"
                                   class="sms-ir-form-control"
                                   id="smsIrVerificationTemplateId"
                                   value="<?= get_option('sms_ir_verification_template_id') ?>"
                                   placeholder="12345">
                            <p class="sms-ir-form-text">
                                <small>شماره قالب ارسال کد تایید را وارد کنید.</small>
                            </p>
                        </td>
                    </tr>
                ...
                <p class="tab-content-tips">
                    جهت کسب اطلاعات بیشتر به وبسایت <a href="https://sms.ir/" target="_blank">www.sms.ir</a> مراجعه نمایید.
                </p>
                <button type="submit" name="sms_ir_setting_button" value="1" class="sms-ir-setting-button button-primary">
                    ذخیره سازی
                </button>
            </div>
