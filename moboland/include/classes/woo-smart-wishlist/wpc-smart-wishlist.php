...
! defined( 'WOOSW_URI' ) && define( 'WOOSW_URI', get_template_directory_uri() . '/include/classes/woo-smart-wishlist/');
! defined( 'WOOSW_DIR' ) && define( 'WOOSW_DIR', get_template_directory() . '/include/classes/woo-smart-wishlist/');
			...
			class WPCleverWoosw {
				...
				function shortcode_btn( $attrs ) {
					...
					if ( $attrs['id'] ) {
						...
						$button_icon = self::get_setting( 'button_icon', 'only' );
						...
						if ( $button_icon !== 'no' ) {
							...
							if ( $button_icon === 'left' ) {
                                ...
                                $btn   = '<i class="woosw-btn-icon ' . esc_attr($icon) . '"></i><span class="add">افزودن به علاقمندی ها</span><span class="added">به علاقمندی ها اضافه شد</span>';
							}
						} else {
							$btn = $text;
						}
                    ...
                    <div class="wpclever_settings_page wrap">
                        ...
                        <div class="wpclever_settings_page_content">
							<?php if ( $active_tab === 'settings' ) {
								...
								$button_action           = self::get_setting( 'button_action', 'message' );
								$message_position        = self::get_setting( 'message_position', 'fluid-bottom' );
