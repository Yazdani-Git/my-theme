	...
	abstract class GetWooPlugins_Plugin_Deactivate_Feedback {
		...
		public function enqueue_scripts() {
			...
			if ( 'plugins' === $screen_id ) {
				...
				wp_enqueue_style( 'getwooplugins_settings', trailingslashit( get_template_directory_uri() . '/include/classes/swatches/includes/getwooplugins/' ) . 'css/getwooplugins-settings.css', array( 'dashicons' ), filemtime( trailingslashit( get_template_directory() . '/include/classes/swatches/includes/getwooplugins/' ) . 'css/getwooplugins-settings.css' ) );

				wp_enqueue_script( 'jquery-tiptip', untrailingslashit( get_template_directory_uri() . '/include/classes/swatches/includes/getwooplugins' ) . '/js/jquery.tipTip.js', array( 'jquery' ), filemtime( trailingslashit( get_template_directory() . '/include/classes/swatches/includes/getwooplugins/' ) . 'js/jquery.tipTip.js' ), true );

				wp_enqueue_script( 'gwp-form-field-dependency', untrailingslashit( get_template_directory_uri() . '/include/classes/swatches/includes/getwooplugins' ) . '/js/getwooplugins-form-field-dependency.js', array( 'jquery' ), filemtime( trailingslashit( get_template_directory() . '/include/classes/swatches/includes/getwooplugins/' ) . 'js/getwooplugins-form-field-dependency.js' ), true );

				wp_enqueue_script( 'wp-color-picker-alpha', untrailingslashit( get_template_directory_uri() . '/include/classes/swatches/includes/getwooplugins' ) . '/js/wp-color-picker-alpha.js', array(
					'jquery',
					'wp-color-picker'
				), filemtime( trailingslashit( get_template_directory() . '/include/classes/swatches/includes/getwooplugins/' ) . 'js/wp-color-picker-alpha.js' ), true );
				...
				wp_enqueue_script( 'getwooplugins_settings', trailingslashit( get_template_directory_uri() . '/include/classes/swatches/includes/getwooplugins/' ) . 'js/getwooplugins-settings.js', $dep, filemtime( trailingslashit( get_template_directory() . '/include/classes/swatches/includes/getwooplugins/' ) . 'js/getwooplugins-settings.js' ), true );
