	...
	class GetWooPlugins_Admin_Menus {
		...
		public function admin_scripts() {
			...
			if ( 'getwooplugins_page_getwooplugins-settings' === $screen_id ) {
				...
				wp_enqueue_style( 'getwooplugins_settings', untrailingslashit( get_template_directory_uri() . '/include/classes/swatches/includes/getwooplugins' ) . '/css/getwooplugins-settings.css', array(), filemtime( trailingslashit( get_template_directory() . '/include/classes/swatches/includes/getwooplugins/' ) . 'css/getwooplugins-settings.css' ) );
				...
				wp_enqueue_script( 'getwooplugins_settings', untrailingslashit( get_template_directory_uri() . '/include/classes/swatches/includes/getwooplugins' ) . '/js/getwooplugins-settings.js', $dep, filemtime( trailingslashit( get_template_directory() . '/include/classes/swatches/includes/getwooplugins/' ) . 'js/getwooplugins-settings.js' ), true );
