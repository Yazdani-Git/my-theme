...
if ( ! class_exists( 'Woo_Variation_Swatches' ) ) {
	...
	class Woo_Variation_Swatches {
		...
		public function plugin_path() {
			return untrailingslashit( get_template_directory() . '/include/classes/swatches' );
		}

		public function plugin_url() {
			return untrailingslashit( get_template_directory_uri() . '/include/classes/swatches' );
		}

		public function images_url( $file = '' ) {
			return untrailingslashit( get_template_directory_uri() . '/include/classes/swatches/' . 'images' ) . $file;
		}
		...
		public function assets_url( $file = '' ) {
			return untrailingslashit( get_template_directory_uri() . '/include/classes/swatches/' . 'assets' ) . $file;
		}
		...
		public function include_path( $file = '' ) {
			return untrailingslashit( get_template_directory() . '/include/classes/swatches/' . 'includes' ) . $file;
		}
